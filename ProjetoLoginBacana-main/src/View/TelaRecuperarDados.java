 ...
 * @author Aluno
 */
public class TelaRecuperarDados extends javax.swing.JFrame {
//    private void TelaOpCadastroUsuarios telaOpCadastroUsuarios;

    public TelaRecuperarDados(/*TelaOpCadastroUsuarios telaOpCadastroUsuarios*/) {
//         this.telaOpCadastroUsuarios = telaOpCadastroUsuarios;
    ...
    private void initComponents() {
        ...
        lblLogo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/icons8-usuário-40.png"))); // NOI18N
        ...
        lblTitutlo.setText("Recuperar Dados de Usuário");
        ...
        btnAtualizar.setText("Recuperar");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaRecuperarDados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaRecuperarDados().setVisible(true);
            }
        });
    }
    ...
    public void recuperaCamposBD(CadastroUsuarioModel usuario) {
